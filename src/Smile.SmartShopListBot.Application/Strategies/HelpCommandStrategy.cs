...
/// <summary>
/// Represents a strategy for handling the <see cref="TelegramCommands.Help"/> command.
/// </summary>
internal sealed class HelpCommandStrategy : CommandStrategyBase<HelpCommandStrategy, CommandTelegramCommand>
{
    /// <summary>
    /// Initializes a new instance of <see cref="HelpCommandStrategy"/> class.
    /// </summary>
    ...
    public HelpCommandStrategy(ITelegramBotService telegramBotService,
        ILocalizationService localizationService,
        ILogger<HelpCommandStrategy> logger) : base(logger)
    {
        _telegramBotService = telegramBotService;
        _localizationService = localizationService;
    }

    #region Overrides of CommandStrategyBase<HelpCommandStrategy,CommandTelegramCommand>
    ...
    {
        return command.CommandName.Equals(TelegramCommands.Help, StringComparison.OrdinalIgnoreCase);
    }
    ...
    public override Task HandleAsync(CommandTelegramCommand command, CancellationToken token)
    {
        ...
        {
            Text = _localizationService.Translate(command.LanguageCode, StringNames.HelpCommandResponseText)
        };
